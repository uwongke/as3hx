...
class Config {
    ...
    */
    ...
    public function fromXml(f:Access) {
        for(el in f.elements) {
            switch(el.name) {
            case "indentChars":         setCharField(el, "    ");
            case "newlineChars":        setCharField(el, "\n");
            case "bracesOnNewline":     setBoolField(el, false);
    ...
    function setBoolField(f:Access, defaultVal:Bool) {
        var val = defaultVal;
        if(f.has.value) {
    ...
    function setCharField(f:Access, defaultVal:String, constrain:Array<String> = null) {
    ...
    function setExcludeField(f:Access, defaultExcludes:List<String>) {
    ...
    function setConditionalVars(f:Access, defaultVars:List<String>) {
    ...
    function setImportPaths(f:Access, defaultVars:Array<String>) {
